  ...
  return (
    <div className="lg:w-4/5 mx-auto w-full p-5">
      <div className="grid md:grid-cols-4 md:grid-rows-5 gap-3 min-h-[1300px]   grid-cols-2 grid-rows-8">
        <div className="md:col-span-3 md:row-span-2 overflow-hidden col-span-2 row-span-1 rounded-lg">
          <Welcome/>
        </div>
        ...
        <div className="bg-red-100 overflow-hidden rounded-lg">C4</div>
        <div className="bg-red-100  overflow-hidden rounded-lg">C5</div>
        <div className="bg-red-100 overflow-hidden row-start-4 col-span-2 md:col-span-2 rounded-lg">
          C6
        </div>
