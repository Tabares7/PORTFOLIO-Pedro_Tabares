  ...
  return (
    <div className="lg:w-4/5 mx-auto w-full p-5">
      <div className="grid md:grid-cols-4 md:grid-rows-5 gap-3 min-h-[1500px] md:min-h-[1300px]   grid-cols-2 grid-rows-8">
        ...
        <div className=" md:col-start-4 md:row-start-1 overflow-hidden rounded-lg shadow-lg shadow-gray-400">
          <GitHub />
        </div>
        ...
        <div className="overflow-hidden row-start-4 md:row-start-3 md:col-start-3 col-span-2 rounded-lg shadow-lg shadow-gray-400">
          <DevProjects />
        </div>
        <div className=" overflow-hidden col-span-2 md:col-span-2 rounded-lg shadow-lg shadow-gray-400">
          <ArtProjects />
        </div>
        <div className=" overflow-hidden rounded-lg shadow-lg shadow-gray-400">
          <Skills />
