...
const DevProjectsGrid = () => {
  return (
    <div className="lg:w-4/5 mx-auto w-full p-5">
      <div className="grid grid-cols-2 grid-rows-8 gap-4 md:grid-cols-4">
        <div className="col-span-2 row-span-1 bg-gray-100 text-black min-h-[180px] rounded-lg shadow-lg shadow-gray-400 overflow-hidden md:min-h-[400px] md:col-span-2">
          <PortfolioProject/>
        </div>
        <div className="col-span-2 row-span-1 bg-gray-100 text-black min-h-[180px] rounded-lg shadow-lg shadow-gray-400 overflow-hidden md:min-h-[400px] md:col-span-2">
          <NewsletterProject/>
        </div>
        <div className="col-span-1 row-span-2 bg-gray-100 text-black min-h-[360px] rounded-lg shadow-lg shadow-gray-400 overflow-hidden md:col-span-1 ">
          <ClinicProject/>
        </div>
