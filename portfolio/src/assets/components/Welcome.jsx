    ...
    >
      <div className="h-full p-10 gap-2  bg-lightgreen bg-opacity-80 sm:bg-opacity-0 flex flex-col text-left w-full sm:w-2/3 ">
        ...
        <p className=" text-darkgrenn lg:text-xl">
          ...
          four years of diving deep into code. But it's not all about coding, I
          also dabble in{" "}
          <span className=" font-bold">
            graphic design, branding, and crafting cool logos
          </span>
          . Always ready to create something functional and stylish.
        </p>
      </div>
    </div>
  );
