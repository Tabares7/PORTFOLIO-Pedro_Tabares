...
const NewsletterProject = () => {
  return (
   <Link target="_blank" to="https://github.com/Tabares7/newsletter-sign-up-with-success-message-main">
    <div
    ...
    > 
        ...
        <h2 className=" font-bold tracking-wide md:text-4xl md:mb-3">📰 Newsletter Project</h2>
