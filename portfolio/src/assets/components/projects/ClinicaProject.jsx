...
import portfolio from "../../img/clinic-ss.png";
  ...
  return (
   <Link to="https://github.com/Tabares7/PORTFOLIO-Pedro_Tabares">
    ...
    >
        ...
        <h2 className=" font-bold tracking-wide md:text-3xl md:mb-3">🏥 Clinic Website</h2>
        <p className="text-sm md:text-xl pr-2">Frontend project for a clinic: intuitive interface for management and medical information lookup.</p>
        </div>
